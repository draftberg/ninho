...
// Constrói o fluxo de caixa mês a mês de um ano inteiro: meses que já
// aconteceram usam os lançamentos reais; meses futuros sem nenhum
// lançamento ainda usam o salário base dos perfis e os valores esperados
// do checklist como projeção, para dar previsibilidade tipo planilha.
